...
import static httputils.Constants.GSON_INSTANCE;
    ...
    public void run() {
        ...
        HttpClientUtil.runAsync(Constants.USERS_LIST, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if (usersNames == null) {
                    // Handle the case where the parsed array is null
                    System.out.println("Parsed user names are null");
                    return;
                }
