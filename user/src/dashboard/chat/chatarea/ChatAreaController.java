package dashboard.chat.chatarea;

import dashboard.chat.api.HttpStatusUpdate;
import dashboard.chat.chatarea.model.ChatLinesWithVersion;
        ...
        if (chatLinesWithVersion.getVersion() != chatVersion.get()) {
            String deltaChatLines = chatLinesWithVersion
                    ...
                    .map(singleChatLine -> {
                        ...
                        return String.format(DATE_TIME_FORMAT, time, time, time, singleChatLine.getUsername(), singleChatLine.getChatString());
